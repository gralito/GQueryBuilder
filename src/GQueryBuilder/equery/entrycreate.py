...
class EntryCreate(EntryQuery):
    ...
    def target(self, columns: [str])->EntryCreate:
        """
        ...
        Returns:
            EntryCreate: return the instance, allowing fluent coding.
        """
        self._target = f"({", ".join(columns)})"
        return self
            
    def values(self, values: [])->EntryCreate:
        """
    ...
    def build_query(self)->EntryCreate:
        """
